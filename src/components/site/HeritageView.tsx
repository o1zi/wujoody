...
const ACCENTS: Record<string, { hex: string; rgb: string }> = {
  bronze: { hex: "#B25430", rgb: "178,84,48" }, // terracotta clay (default)
  terracotta: { hex: "#B25430", rgb: "178,84,48" },
  azure: { hex: "#3E6E8E", rgb: "62,110,142" }, // muted teal
  sage: { hex: "#7A7A3E", rgb: "122,122,62" }, // olive
};
...
function Slot({ src, label, kind = "image" }: { src: string | null; label: string; kind?: "person" | "image" }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: "#EFE6D2" }}>
...
function HrSocial({ href, label, children }: { href: string; label: string; children: ReactNode }) {
  return (
...
export default function HeritageView({ content, slug, caps }: { content: SiteContent; slug: string; caps: PlanCaps }) {
  ...
  const head = (kicker: string) => (
    <div className="hr-head hr-reveal">
      <span className="hr-kicker"><span className="hr-orn" />{kicker}<span className="hr-orn" /></span>
    </div>
  );
    ...
    >
      ...
      {waHref || tkHref || snHref || igHref || lnHref ? (
        <div className="hr-social">
          {waHref ? (
            <HrSocial href={waHref} label="تواصل عبر واتساب">
      ...
      <header className="hr-top">
        ...
        <button className="hr-menu" aria-label="القائمة"><span /><span /><span /></button>
      </header>
      ...
      <div className="hr-content">
        <main id="top">
          ...
          <section className="hr-hero">
            <div className="hr-wrap hr-hero-inner">
              <div className="hr-hero-band hr-tri hr-reveal" />
              <div className="hr-hero-kicker hr-reveal" data-d="1">{content.hero.eyebrow}</div>
              <h1 className="hr-hero-title hr-reveal" data-d="1">{Brand}</h1>
              <p className="hr-hero-sub hr-reveal" data-d="2">{content.hero.subtitle}</p>
              <div className="hr-hero-meta hr-reveal" data-d="3">
              ...
              <div className="hr-scrollcue hr-reveal" data-d="4"><span className="hr-orn orn" />SCROLL</div>
            </div>
          </section>
            ...
            <section className="hr-sec" id="about">
              <div className="hr-wrap">
                ...
                <div className="hr-about">
                  <div className="hr-reveal" data-d="1">
                    <h2 className="hr-about-lead">{content.about.lead}</h2>
                    <p className="hr-about-body">{content.about.body}</p>
                  </div>
                  <div className="hr-side hr-reveal" data-d="2">
          ...
          {show("credentials") && (content.credentials.badges.length > 0 || content.credentials.clients.length > 0) && (
            <section className="hr-sec" id="credentials">
              <div className="hr-wrap">
                {head("الاعتمادات والثقة")}
                {content.credentials.lead ? <p className="hr-lead hr-reveal" data-d="1" style={{ marginBottom: 34 }}>{content.credentials.lead}</p> : null}
                {content.credentials.badges.length > 0 && (
                  <div className="hr-cred hr-reveal" data-d="2">
                ...
                {content.credentials.clients.length > 0 && (
                  <div className="hr-clients hr-reveal" data-d="3">
                    {content.credentials.clients.map((cl, i) => (
                      <div className="hr-client" key={i} title={cl.name}>
                        {cl.logo ? (
                          // eslint-disable-next-line @next/next/no-img-element
          ...
          {/* SERVICES */}
          {show("services") && (
            <section className="hr-sec" id="services">
              <div className="hr-wrap">
                {head("الخدمات")}
                <h2 className="hr-title hr-reveal" data-d="1" style={{ textAlign: "center", marginBottom: 12 }}>{content.services.title}</h2>
                <p className="hr-lead hr-reveal" data-d="2" style={{ textAlign: "center", marginBottom: 48 }}>{content.services.lead}</p>
                <div className="hr-svc-grid">
                  {content.services.items.map((s, i) => (
                    <div className="hr-svc hr-reveal" data-d={(i % 3) + 1} key={i}>
          ...
          {/* STATS */}
          {show("stats") && (
            <section className="hr-sec" id="stats">
              <div className="hr-wrap">
                {head("بالأرقام")}
                <div className="hr-stats">
                  {content.stats.map((st, i) => {
                    ...
                    return (
                      <div className="hr-stat hr-reveal" data-d={(i % 4) + 1} key={i}>
                        <div className="num">
          ...
          {/* PROCESS */}
          {show("process") && (
            <section className="hr-sec" id="process">
              <div className="hr-wrap">
                {head("منهجية العمل")}
                <div className="hr-proc">
                  {content.process.map((p, i) => (
                    <div className="hr-step hr-reveal" data-d={(i % 4) + 1} key={i}>
          ...
          {/* TEAM */}
          {show("team") && (
            <section className="hr-sec" id="team">
              <div className="hr-wrap">
                {head("الفريق")}
                <h2 className="hr-title hr-reveal" data-d="1" style={{ textAlign: "center", marginBottom: 48 }}>عقولٌ تقف خلف كل عمل.</h2>
                <div className="hr-team">
                  {content.team.items.map((mb, i) => (
                    <div className="hr-member hr-reveal" data-d={(i % 4) + 1} key={i}>
          ...
          {show("testimonials") && content.testimonials.length > 0 && (
            <section className="hr-sec" id="voices">
              <div className="hr-wrap">
                {head("آراء العملاء")}
                <div className="hr-quotes">
                  {content.testimonials.map((t, i) => (
                    <div className="hr-quote hr-reveal" data-d={(i % 3) + 1} key={i}>
          ...
          {show("faq") && content.faq.items.length > 0 && (
            <section className="hr-sec" id="faq">
              <div className="hr-wrap">
                {head("الأسئلة الشائعة")}
                <div className="hr-faq hr-reveal" data-d="1">
          ...
          {/* BOOKING */}
          {show("booking") && (
            <section className="hr-sec" id="booking">
              <div className="hr-wrap">
                {head("احجز استشارة")}
                <h2 className="hr-title hr-reveal" data-d="1" style={{ textAlign: "center", marginBottom: 12 }}>احجز استشارتك الأولى</h2>
                <p className="hr-lead hr-reveal" data-d="2" style={{ textAlign: "center", marginBottom: 40 }}>اختر الوقت المناسب لك وسيتواصل معك أحد مهندسينا لتأكيد الموعد.</p>
                <div className="hr-card hr-reveal" data-d="2" style={{ maxWidth: 660, margin: "0 auto" }}>
          ...
          {show("calculator") && content.calculator.types.some((t) => t.name) && (
            <section className="hr-sec" id="calculator">
              <div className="hr-wrap">
                {head("حاسبة التكلفة")}
                {content.calculator.lead ? <p className="hr-lead hr-reveal" data-d="1" style={{ textAlign: "center", marginBottom: 36 }}>{content.calculator.lead}</p> : null}
                <div className="hr-card hr-reveal" data-d="2" style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          {/* CONTACT */}
          {show("contact") && (
            <section className="hr-sec" id="contact">
              <div className="hr-wrap">
                {head("تواصل معنا")}
                <h2 className="hr-title hr-reveal" data-d="1" style={{ textAlign: "center", marginBottom: 48 }}>لديك مشروع؟ لنبدأه معاً.</h2>
                <div className="hr-contact">
                  <div className="hr-card hr-reveal" data-d="1">
                    <ContactForm slug={slug} waNumber={caps.whatsapp && waNumber.length >= 8 ? waNumber : ""} brand={brand.ar} />
                  </div>
                  <div className="hr-card hr-cinfo hr-reveal" data-d="2">
                ...
                {content.contact.mapQuery ? (
                  <div className="hr-map hr-reveal" data-d="2">
                    <iframe
                      title="موقع المكتب"
                      src={`https://www.google.com/maps?q=${encodeURIComponent(content.contact.mapQuery)}&z=15&output=embed`}
                      width="100%"
                      height="320"
                      style={{ border: 0, display: "block", filter: "sepia(0.25) contrast(1.05) saturate(0.95)" }}
                      loading="lazy"
        ...
        <footer className="hr-foot">
          <div className="hr-wrap">
            <div className="hr-foot-band hr-tri hr-reveal" />
            <div className="big hr-reveal">{Brand}</div>
            <p className="tag hr-reveal" data-d="1">{content.hero.subtitle}</p>
            <div className="hr-foot-nav hr-reveal" data-d="1">
              {show("about") && <a href="#about">من نحن</a>}
              {show("services") && <a href="#services">الخدمات</a>}
              {show("projects") && <a href="#projects">المشاريع</a>}
              {show("team") && <a href="#team">الفريق</a>}
