...
const ACCENTS: Record<string, { hex: string; rgb: string }> = {
  bronze: { hex: "#C77B43", rgb: "199,123,67" }, // amber / terracotta-gold (default)
  terracotta: { hex: "#C77B43", rgb: "199,123,67" },
  azure: { hex: "#6E9BB0", rgb: "110,155,176" }, // dusk blue
  sage: { hex: "#9DA86A", rgb: "157,168,106" }, // olive
};
...
function Slot({ src, label, kind = "image" }: { src: string | null; label: string; kind?: "person" | "image" }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", background: "#1B1714" }}>
      <div style={{ position: "absolute", width: 180, height: 180, borderRadius: "50%", background: "radial-gradient(circle, rgba(var(--accent-rgb),.22), transparent 70%)" }} />
...
function AtSocial({ href, label, children }: { href: string; label: string; children: ReactNode }) {
  return (
...
export default function AtelierView({ content, slug, caps }: { content: SiteContent; slug: string; caps: PlanCaps }) {
  ...
  const head = (index: string, kicker: string) => (
    <div className="at-head at-reveal">
      <span className="at-index">{index}</span>
  ...
  return (
    ...
    >
      ...
      <div className="at-spot" aria-hidden="true" />
      <div className="at-vig" />
      <div className="at-grain" />

      {/* floating social */}
      {waHref || tkHref || snHref || igHref || lnHref ? (
        <div className="at-social">
          {waHref ? (
            <AtSocial href={waHref} label="تواصل عبر واتساب">
      ...
      <header className="at-top">
        ...
        <button className="at-menu" aria-label="القائمة"><span /><span /><span /></button>
      </header>
      ...
      <div className="at-content">
        <main id="top">
          ...
          <section className="at-hero">
            <div className="at-wrap" style={{ width: "100%" }}>
              <div className="at-hero-kicker at-reveal">{content.hero.eyebrow}</div>
              <h1 className="at-hero-title at-reveal" data-d="1">{Brand}</h1>
              <div className="at-hero-grid">
                <div>
                  <p className="at-hero-sub at-reveal" data-d="2">{content.hero.subtitle}</p>
                  <div className="at-scrollcue at-reveal" data-d="3"><span className="m" />SCROLL</div>
                </div>
                <div className="at-hero-meta at-reveal" data-d="2">
              ...
              <div className="at-wrap">
                ...
                <div className="at-about">
                  <div className="at-reveal" data-d="1">
                    ...
                    <p className="at-about-body">{content.about.body}</p>
                  </div>
                  <div className="at-side at-reveal" data-d="2">
              ...
              <div className="at-wrap">
                ...
                <div className="at-svc-grid">
                  {content.services.items.map((s, i) => (
                    <div className="at-svc at-reveal" data-d={(i % 3) + 1} key={i}>
          ...
          {show("credentials") && (content.credentials.badges.length > 0 || content.credentials.clients.length > 0) && (
            <section className="at-sec" id="credentials">
              <div className="at-wrap">
                {head("★", "الاعتمادات · Credentials")}
                {content.credentials.lead ? <p className="at-lead at-reveal" data-d="1" style={{ marginBottom: 30 }}>{content.credentials.lead}</p> : null}
                {content.credentials.badges.length > 0 && (
                  <div className="at-cred at-reveal" data-d="2">
                ...
                {content.credentials.clients.length > 0 && (
                  <div className="at-clients at-reveal" data-d="3">
                    {content.credentials.clients.map((cl, i) => (
                      <div className="at-client" key={i} title={cl.name}>
                        {cl.logo ? (
                          // eslint-disable-next-line @next/next/no-img-element
              ...
              <div className="at-wrap">
                ...
                <div className="at-stats">
                  {content.stats.map((st, i) => {
                    ...
                    return (
                      <div className="at-stat at-reveal" data-d={(i % 4) + 1} key={i}>
                        <div className="num">
          ...
          {/* TEAM */}
          {show("team") && (
            <section className="at-sec" id="team">
              <div className="at-wrap">
                {head("06", "الفريق · Team")}
                <h2 className="at-title at-split" style={{ marginBottom: 40 }}>العقول خلف العمل.</h2>
                <div className="at-team">
                  {content.team.items.map((mb, i) => (
                    <div className="at-member at-reveal" data-d={(i % 4) + 1} key={i}>
          ...
          {show("testimonials") && content.testimonials.length > 0 && (
            <section className="at-sec" id="voices">
              <div className="at-wrap">
                {head("07", "آراء العملاء · Clients")}
                <div className="at-quotes">
                  {content.testimonials.map((t, i) => (
                    <div className="at-quote at-reveal" data-d={(i % 3) + 1} key={i}>
          ...
          {show("faq") && content.faq.items.length > 0 && (
            <section className="at-sec" id="faq">
              <div className="at-wrap">
                {head("08", "الأسئلة الشائعة · FAQ")}
                <div className="at-faq at-reveal" data-d="1">
          ...
          {/* BOOKING */}
          {show("booking") && (
            <section className="at-sec" id="booking">
              <div className="at-wrap">
                {head("09", "احجز استشارة · Book")}
                <h2 className="at-title at-split" style={{ marginBottom: 14 }}>احجز استشارتك الأولى.</h2>
                <p className="at-lead at-reveal" data-d="1" style={{ marginBottom: 40 }}>اختر الوقت المناسب لك وسيتواصل معك أحد مهندسينا لتأكيد الموعد.</p>
                <div className="at-reveal" data-d="2" style={{ maxWidth: 660 }}>
          ...
          {show("calculator") && content.calculator.types.some((t) => t.name) && (
            <section className="at-sec" id="calculator">
              <div className="at-wrap">
                {head("~", "حاسبة التكلفة · Estimate")}
                {content.calculator.lead ? <p className="at-lead at-reveal" data-d="1" style={{ marginBottom: 34 }}>{content.calculator.lead}</p> : null}
                <div className="at-reveal" data-d="2">
          ...
          {/* CONTACT */}
          {show("contact") && (
            <section className="at-sec" id="contact">
              <div className="at-wrap">
                {head("10", "تواصل معنا · Contact")}
                <h2 className="at-title at-split" style={{ marginBottom: 40 }}>لديك مشروع؟ لنبدأه معاً.</h2>
                <div className="at-contact">
                  <div className="at-reveal" data-d="1">
                    <ContactForm slug={slug} waNumber={caps.whatsapp && waNumber.length >= 8 ? waNumber : ""} brand={brand.ar} />
                  </div>
                  <div className="at-cinfo at-reveal" data-d="2">
                ...
                {content.contact.mapQuery ? (
                  <div className="at-map at-reveal" data-d="2">
                    <iframe
                      title="موقع المكتب"
                      src={`https://www.google.com/maps?q=${encodeURIComponent(content.contact.mapQuery)}&z=15&output=embed`}
                      width="100%"
                      height="320"
                      style={{ border: 0, display: "block", filter: "invert(0.92) hue-rotate(180deg) brightness(0.92) contrast(0.92) saturate(0.7) sepia(0.15)" }}
                      loading="lazy"
        ...
        <footer className="at-foot">
          <div className="at-wrap">
            <div className="at-foot-grid">
              <div>
                <div className="big at-reveal">{Brand}</div>
                <p className="tag at-reveal" data-d="1">{content.hero.subtitle}</p>
              </div>
              <div className="col at-reveal" data-d="1">
                <h4>الموقع</h4>
                {show("about") && <a href="#about">من نحن</a>}
                {show("services") && <a href="#services">الخدمات</a>}
                {show("projects") && <a href="#projects">المشاريع</a>}
              ...
              <div className="col at-reveal" data-d="2">
                <h4>تواصل</h4>
