...
export const defaultLanding: LandingContent = {
  ...
  hero: {
    ...
    subtitle:
      "موقع احترافي لمكتبك الهندسي بنطاقٍ فرعي خاص — سجّل، اشترك باشتراكٍ سنوي عبر تحويل بنكي، وخصّص موقعك من لوحة واحدة. بلا خبرة تقنية.",
    meta: [
  ...
  features: {
    ...
    items: [
      ...
      { title: "اشتراك سنوي ميسّر", desc: "حوّل قيمة الباقة بنكياً وأرسل الإيصال، ويُفعّل موقعك مباشرة." },
    ],
  },
  steps: {
    ...
    items: [
      ...
      { title: "اشترك بتحويل بنكي", desc: "اختر باقتك السنوية، حوّل المبلغ، وأرسل الإيصال عبر واتساب." },
      { title: "عدّل وانطلق", desc: "خصّص محتوى موقعك من اللوحة، وموقعك يصبح حياً فوراً." },
    ],
  },
  pricing: {
    title: "باقات تناسب كل مكتب.",
    lead: "اشتراك سنوي بتحويل بنكي — حوّل المبلغ وأرسل الإيصال، ويُفعّل موقعك يدوياً خلال وقت قصير.",
  },
  cta: {
